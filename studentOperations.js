...
export default async function userOperations() {
    let quitStudentManagementSystem = false;
    do {
            ...
            case "Student Enrollment":
                const studentEnrollment = await inquirer.prompt([
                    ...
                    },
                    {
                        ...
                        validate(studentPhone) {
                            if (studentPhone.trim().length === 0) {
                                return chalk.redBright("Please, Enter the Student Phone Number!!!");
                            }
                            else if (isNaN(studentPhone) || studentPhone.length !== 13) {
                                return chalk.redBright("Please, Enter valid Student Phone Number!!!");
                            }
                            else {
                                return true;
                            }
                    ...
                    },
                    {
                        ...
                        validate(studentbalance) {
                            if (studentbalance.trim().length === 0 || isNaN(studentbalance)) {
                                return chalk.redBright("Please, Enter the Student Balance(in Numbers)!!!");
                            }
                            else if (studentbalance.length < 5) {
                                return chalk.redBright("Minimum Student Balance required is 10000!!!");
                            }
                            else {
                                return true;
                            }
                ...
                const student = new Student(studentEnrollment.studentName, studentEnrollment.studentPhone, studentEnrollment.studentEmail, +studentEnrollment.studentbalance);
                    ...
                    .prompt([
                    {
                        ...
                        validate(addBalance) {
                            if (addBalance.trim().length === 0 || isNaN(addBalance)) {
                                ...
                                return chalk.redBright("Minimum Amount you can add is 10000!!!");
                            }
                            else {
                                return true;
                            }
